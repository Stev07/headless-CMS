			...
			<div class="portlet box vivid-green">
				<div class="portlet-title">
					...
					<p class="premium-editions">
						<?php echo esc_attr( $cpb_upgrade_need_help ); ?><a href="https://captcha-bank.tech-banker.com/" target="_blank" class="premium-editions-documentation"><?php echo esc_attr( $cpb_documentation ); ?></a><?php echo esc_attr( $cpb_read_and_check ); ?><a href="https://captcha-bank.tech-banker.com/frontend-demos/" target="_blank" class="premium-editions-documentation"><?php echo esc_attr( $cpb_demos_section ); ?></a>
					</p>
				</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<a href="https://www.google.com/recaptcha/" target="_blank" id="ux_link_reference" class="recaptcha-style"><span id="ux_link_content"> ( Get API Key </a> / <a class="recaptcha-style" href="https://captcha-bank.tech-banker.com/documentation/google-recaptcha-api/" target="
															"> How to Setup? )</a></span>
