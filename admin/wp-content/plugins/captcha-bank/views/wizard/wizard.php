				...
				<div class="page-container header-wizard">
					<div class="page-content">
						...
						<div class="col-md-12 terms">
							<a href="<?php echo esc_attr( TECH_BANKER_BETA_URL ); ?>/privacy-policy/" target="_blank"><?php echo esc_attr( __( 'Privacy Policy', 'captcha-bank' ) ); ?></a>
							<span> - </span>
							<a href="<?php echo esc_attr( TECH_BANKER_BETA_URL ); ?>/terms-conditions/" target="_blank"><?php echo esc_attr( __( 'Terms &amp; Conditions', 'captcha-bank' ) ); ?></a>
						</div>
					</div>
				</div>
			</div>
